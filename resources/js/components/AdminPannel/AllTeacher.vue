                        ...
                        <v-list  class="grey lighten-4 ma-0 pa-0" subheader>
                            ...
                            >
                                <v-list-item-avatar>
                                    ...
                                    <v-img :src="'https://jubayerahmed.com/lms/public/uploads/x/x/profile/'+ teacher.image"
                                           v-else></v-img>
                                </v-list-item-avatar>
                                <v-list-item-content>
...
<script>
    import CreateTeacherDialog from "./CreateTeacherDialog.vue";
    ...
    export default {
        components: {Teacher_details_dialog, teacher_Assign_dialog,Delete_Request,userEditProfile,CreateTeacherDialog},
        ...
        created() {
            this.deleteteacher();
            this.createTeacherUpadate();
        },
        methods:{
            createTeacherUpadate()
            {
                EventBus.$on('newTeacher',(teacher) =>{
                    this.data.unshift(teacher)
                })
            },
            changing(){
                this.y=1;
